# Part 6d - Feature Control (optional)
## Table of Contents
...
* [Previous: 6c. Validations](6c.md)  
* **Current: 6d. Feature Control (optional)**  
    * [Introduction](#markdown-header-introduction)  
    * [Defining Feature Control](#markdown-header-defining-feature-control)  
    * [Implementing Feature Control ](#markdown-header-implementing-feature-control)   
...
Feature control can be done in two ways:  
...
[^ Top of page](#)  
Dynamic feature controls must be implemented in the behavior implementation in the method `get_instance_features` of your behavior pool `zbp_raph_##_i_travelwdtp`. This (for now empty) method is already available in the class under `Local Types` and just has to be implemented.  
