...
Please add master data associations to the following CDS Views whereever possible: `/DMO/I_Agency`, `/DMO/I_Customer`, `/DMO/I_Carrier`, `/DMO/I_Connection`, `/DMO/I_Supplement`, `/DMO/I_SupplementText`, `ZRAPH_I_Hotel`, `ZRAPH_I_HotelRoomType`, `ZRAPH_I_OverallStatus` and `I_Currency`.  
