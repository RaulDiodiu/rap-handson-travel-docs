...
#### MDE Creation
Start by right-clicking the identically named CDS Consumption View and select _New Metadata Extension_. As discussed above, name the MDE identically to the CDS View `ZRAPH_##_C_TravelWDTP` and select the template `Annotate Entity`.
