...
The newly created Service Binding will open without showing too much information. Let’s click `Activate` or `Publish` on the top right. Now the table Entity Set and Association on the right will be filled with all our provided objects and the associations they provide. That’s basically it, the OData service was generated and can be used already.
