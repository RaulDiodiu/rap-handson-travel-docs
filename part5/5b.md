...
* **Current: 5b. Implementing Basic Authorizations (optional)**  
    ...
    * [Creating a CDS Access Control for ZRAPH_##_I_TravelWDTP](#markdown-header-creating-a-cds-access-control-for-zraph_##_i_travelwdtp)  
    * [Inheriting the CDS Access Control in ZRAPH_##_C_TravelWDTP](#markdown-header-inheriting-the-cds-access-control-in-zraph_##_c_travelwdtp)  
