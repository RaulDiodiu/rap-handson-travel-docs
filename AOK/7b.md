...
[^ Top of page](#)  
As part of the *Template Selection* step, we will pick the *List Report Page* floorplan and finally press *Next*.

![alt](images/image6_3.png)

[^ Top of page](#)  
In the next step, the *Data source* (Connect to a System), *System* (ABAP Environment on BTP), and *Service* (your personal OData service ZRAPH_##_UI_TRAVELWDTP_V2) will be selected. Provide this information and press *Next*.
