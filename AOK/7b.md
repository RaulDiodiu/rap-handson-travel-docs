...
* **Current: 7b. VS Code - Fiori Tools**  
...
[^ Top of page](#)  
Now press _Finish_ and wait for the magic to happen. After a few seconds your first SAP Fiori List Report app was generated and can be opened by using *Open folder* in VS Code.  
...
**Important:** Due to the AOK Systems proxy settings we have to adjust something. Please open the `ui5.yaml` file and configure `ignoreCertError: true` instead of false. Save your changes and close the file again.
