...
[^ Top of page](#)  
In the next step, the *Data Source* (your SAP BTP ABAP Environment) and *Service* will be selected. The Data Source type in our case will be *Connect to a System*.  
 
Please provide now your default connection to the SAP BTP ABAP Environment and your Service Binding created previously in the part [5. Publishing the Business Service](../part5/README.md) and finally press *Next*.
...
[^ Top of page](#)  
In the appearing pop-up select the first npm script *start* and now your freshly created app will start. It may take a few moments until it starts, but finally your app will appear in an additional browser tab. You have to know that you have to disable the popup blocker (if necessary) and preview the app again.
