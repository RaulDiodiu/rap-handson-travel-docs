...
[^ Top of page](#)  
Now press _Finish_ and wait for the magic to happen. After a few seconds your first SAP Fiori List Report app was generated and can be opened by using *Open folder* in SAP Business Application Studio and finally the project will be available as part of a new workspace.
