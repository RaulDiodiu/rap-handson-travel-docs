...
#### Enable the draft.
- Add the addition "with draft;" ina new line after the `managed ...;` line in the header section of the Behavior Definition to enable draft handling for your business object.
