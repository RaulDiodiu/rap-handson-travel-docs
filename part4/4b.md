...
#### Enable the draft.
- Add the addition "with draft;" after the managed; keyword in the header section of the Behavior Definition to enable draft handling for your business object.
